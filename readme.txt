...
== Description ==
MangoFp allows to manage Contact Form 7 messages directly in WordPress like leads in CRM system. Information and service requests, various registration forms - all can be managed according to the tailor-made process that is best for your team.
...
4. In Admin Area open MangoFP->Settings. On tab \"Parameters\" you can specify \"Email field\" if that is something else thant \"your-email\". On tab \"efine process steps\" you can modify process for management of the messages.  See detailed instrucitons on plugin webpage (https://mangofp.net)
...
1. Main php code: https://github.com/wpkonsult/mangofp.git
2. Front end for messages management: https://github.com/wpkonsult/mangofp.git
3. Front end for settings and process configruation:  https://github.com/wpkonsult/mangofp-settings-ts.git